    ...
    <main className="flex flex-col gap-5">
      <div>
        ...
        <div className="text-white/60 text-[13px] font-semibold mt-2 leading-relaxed">
          Milestones every 7 days. You can’t proceed without a clinical re-measurement.
        </div>
      </div>

      <div className="rounded-3xl border border-white/12 bg-white/6 backdrop-blur-xl shadow-soft p-5">
        <div className="text-white font-extrabold text-[15px]">Phase 1 — Tissue Activation (Days 1–16)</div>
              ...
              >
                <div className="min-w-0">
                  <div className="text-white font-extrabold text-[13px]">
                    Day {day}{isMilestone ? " — Clinical Check-in" : ""}
                  </div>

                  {isMilestone && (
                    <div className="text-white/60 text-[12px] font-semibold mt-1">
                      Re-measure your gap to unlock progression.
                    </div>
                  )}
                </div>
                  ...
                  {isMilestone ? (
                    (day === 7 ? day7Done : day14Done) ? (
                      ...
                      >
                        ...
                        <span className="text-white text-[11px] font-extrabold">Do Check-in</span>
                      </Link>
                    )
                  ) : locked ? (
        ...
        {(lockedAfter7 || lockedAfter14) && (
          <div className="mt-4 rounded-2xl border border-yellow-500/25 bg-yellow-500/10 px-4 py-3">
            <div className="text-yellow-100 font-extrabold text-[13px]">Clinical Lock Active</div>
            <div className="text-yellow-100/75 text-[12px] font-semibold mt-1">
              Complete your Gap Lab check-in to proceed safely.
            </div>
          </div>
        )}
      </div>
