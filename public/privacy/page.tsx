...
export default function PrivacyPolicy() {
  return (
    <section style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'sans-serif', color: '#333', lineHeight: '1.6' }}>
      <h1 style={{ fontFamily: 'Georgia, serif', color: '#1A1A26' }}>Privacy Policy</h1>
